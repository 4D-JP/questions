...
なお，上記のように[TEXT TO BLOB](http://doc.4d.com/4Dv13/4D/13.5/TEXT-TO-BLOB.301-1457496.ja.html)を何度も使用してHTMLを構築するようなコードは，メモリを何度も再確保することになるため，あまり効率的ではありません。コードでHTMLを構築するのであれば，[PROCESS 4D TAGS](http://doc.4d.com/4Dv13/4D/13.5/PROCESS-4D-TAGS.301-1457565.ja.html)と__テンプレート__を使用したほうがずっと高速です。

それに，TEXT TO BLOBは，互換性のためだけに残されている__旧コマンド__です。TEXTをBLOBに変換するための現コマンドは，[CONVERT FROM TEXT](http://doc.4d.com/4Dv13/4D/13.5/CONVERT-FROM-TEXT.301-1457676.ja.html)です。
